...
const nav_link_class_active =
  nav_link_class.replace("bg-opacity-20", " ") + " underline ";
function Navbar() {
  const menuItems = [
    {
      name: "Home",
        ...
        <div className="lg:hidden z-20">
          ...
          >
            <span
              className={`${
                active
                  ? styles.line + " " + styles.line1 + " " + styles.active
            ...
            <span
              className={`${
                active
                  ? styles.line + " " + styles.line2 + " " + styles.active
            ...
            <span
              className={`${
                active
                  ? styles.line + " " + styles.line3 + " " + styles.active
